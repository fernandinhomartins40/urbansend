...
# UltraZend Simple GitHub Deploy Script (Node.js direto, sem Docker/Nginx)
set -euo pipefail
...
echo "🚀 UltraZend GitHub Deployment"
echo "=============================="
...
echo "   Port: 25 (SMTP)"
echo ""
echo "🎯 Deployment completed with simplified architecture:"
