...
export function LandingPage() {
  ...
  return <main className="velo-page">
    ...
    <section className="velo-proof"><p className="velo-section-kicker"><Sparkles aria-hidden="true" /> CONFIANÇA</p><h2>Mais que envio. Resultados reais.</h2><p className="velo-section-lead">Empresas que confiam na VeloMail para entregar sua comunicação.</p><div className="proof-stats"><div><Mail /><b>+99%</b><span>Taxa de entrega</span></div><div><BarChart3 /><b>50M+</b><span>E-mails enviados</span></div><div><Webhook /><b>2.500+</b><span>Aplicações em produção</span></div><div><Star /><b>99,9%</b><span>Uptime da plataforma</span></div></div><div className="logo-cloud" aria-label="Tecnologias e empresas parceiras"><span><img src="https://cdn.simpleicons.org/stripe/94a3b8" alt="Stripe" /></span><span><img src="https://cdn.simpleicons.org/vercel/94a3b8" alt="Vercel" /></span><span><img src="https://cdn.simpleicons.org/supabase/94a3b8" alt="Supabase" /></span><span><img src="https://cdn.simpleicons.org/docker/2496ed" alt="Docker" /></span><span><img src="https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg" alt="Amazon Web Services" /></span><span><img src="https://cdn.simpleicons.org/googlecloud/4285f4" alt="Google Cloud" /></span></div></section>
