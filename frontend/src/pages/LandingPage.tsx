...
import { ArrowRight, BarChart3, BookOpen, Braces, Check, Copy, Github, Instagram, KeyRound, Linkedin, LockKeyhole, Mail, Menu, ShieldCheck, Sparkles, Star, Webhook, X, Youtube, Zap } from 'lucide-react'
...
export function LandingPage() {
  ...
  return <main className="velo-page">
    ...
    <footer className="velo-footer" id="blog"><div className="velo-footer-top"><div className="footer-brand"><img src="/landing/logo-white.png" alt="VeloMail" /><p>Infraestrutura de e-mail transacional para aplicações que vão mais longe.</p></div><div><b>Produto</b><a href="#recursos">Recursos</a><a href="#precos">Preços</a><a href="#integracoes">Integrações</a><a href="#">Changelog</a></div><div><b>Desenvolvedores</b><Link to="/developers">Documentação</Link><a href="#">API</a><a href="#">SDKs</a><a href="#">Status</a></div><div><b>Empresa</b><a href="#">Sobre</a><a href="#blog">Blog</a><a href="#">Suporte</a><a href="#">Contato</a></div><div><b>Siga-nos</b><div className="socials"><a href="#" aria-label="LinkedIn"><Linkedin /></a><a href="#" aria-label="GitHub"><Github /></a><a href="#" aria-label="YouTube"><Youtube /></a><a href="#" aria-label="Instagram"><Instagram /></a></div></div></div><div className="velo-footer-bottom"><span>© 2026 VeloMail. Todos os direitos reservados.</span><div><a href="#">Termos de uso</a><a href="#">Política de privacidade</a><a href="#">Status</a></div></div></footer>
  </main>
}
